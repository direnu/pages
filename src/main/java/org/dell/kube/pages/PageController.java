...
public class PageController {
    ...
    public ResponseEntity<Page> create(@RequestBody Page page) {
        logger.info("CREATE-INFO:creating a  page ");
        logger.debug("CREATE-DEBUG:creating a  page ");
        Page newPage= pageRepository.create(page);

        logger.info("CREATE-INFO:created a  page with id = " + page.id);
        logger.debug("CREATE-DEBUG:created a  page  with id = " + page.id);
